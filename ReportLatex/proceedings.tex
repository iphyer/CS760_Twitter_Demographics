...
\numberofauthors{3}
\author{%
  \alignauthor{Xinyi Liu\\
    %\affaddr{for Submission}\\
    %\affaddr{City, Country}\\
    \email{xliu636@wisc.edu}}\\
  \alignauthor{Faust Shi\\
    %\affaddr{for Submission}\\
    %\affaddr{City, Country}\\
    \email{shi86@wisc.edu}}\\
...
\begin{abstract}
  UPDATED---\today. Social media data contain multiple kinds of 
  information, indicating users' demographic characteristics and 
  travel patterns. User travel patterns are widely studied using 
  these data while not as systematic as using other data sources 
  such as cell phone data. This paper tries to use travel patterns 
  derived from a large amount of tweets to predict user's gender, 
  which is a part of a larger demographic prediction project. This 
  project connects two kinds of information derived from online 
  tweets - demographic information and spatio-temporal information.
\end{abstract}
...
personal information. Among these information, demographic characteristics
and travel patterns are two of great interest to geographers. Demographic 
characteristics include gender, age, occupation and so on, which is not only
very useful by itself, but is also an important element in travel pattern
