...
We provide all our data and program in Github and you can check them online \url{https://github.com/iphyer/cs760_TwitterDemographics}.  We mainly use scikit-learn \cite{scikit-learn} as our machine learning program library and processing data by Pandas \cite{mckinney2015pandas}.
